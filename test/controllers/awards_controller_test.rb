...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { name: @award.name, student_id: @award.student_id, year: @award.year } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { name: @award.name, student_id: @award.student_id, year: @award.year } }
